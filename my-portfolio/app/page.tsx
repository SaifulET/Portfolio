...
• Tasks store title, description, due date, priority; real-time reordering with priority recalculation. "/>
          <ServiceCard icon={<FaLightbulb />} title="Bluestar Interiors Showcase" description="Explore three unique design styles with detailed galleries and easy contact for a seamless client experience."url="https://bluestarmgt.com/"tech="React Tailwind Express Nodemailer" fullDes=" A sleek and interactive web platform for Bluestar Interiors, highlighting their three main interior design styles. Each style features detailed subsections with engaging descriptions and image galleries, giving users a clear glimpse into their design offerings. Users can easily reach out via a built-in contact form to send emails directly to the admin, making inquiries or requests seamless. Perfect for showcasing creativity while connecting with potential clients. "/>
